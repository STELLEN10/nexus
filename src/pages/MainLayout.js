...
export default function MainLayout() {
  ...
  const handleCreateRoom = async (e) => {
    ...
    setShowCreateRoom(false); setNewRoom({ name: "", description: "", type: "public" });
    navigate(`/chat/${id}`);
  };
  ...
  return (
    <div className="shell">
      ...
      <aside className="sidebar">
        ...
        {is("/chat") && (
          <>
            <div className="sidebar-head"><span>Channels</span><button className="icon-btn" onClick={() => setShowCreateRoom(v => !v)}><svg width="13" height="13" viewBox="0 0 16 16"><path d="M8 3v10M3 8h10" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg></button></div>
            {showCreateRoom && (
              <form className="create-room-form" onSubmit={handleCreateRoom}>
                ...
                <select value={newRoom.type} onChange={e => setNewRoom({ ...newRoom, type: e.target.value })}><option value="public">Public</option><option value="private">Private</option></select>
